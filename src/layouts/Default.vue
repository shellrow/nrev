...
//import NetProbeLogo from "../assets/netprobe_icon.png";
...
<template>
        ...
        <el-container>
            <el-header>
                <el-menu :default-active="activeIndex" mode="horizontal" :ellipsis="false" @select="handleSelect">
                    ...
                    <!-- <router-link to="/">
                        <img class="img" :src="NetProbeLogo" width="40" style="margin-left: 4px; margin-top: 10px" />
                    </router-link> -->
    ...
    <el-dialog v-model="dialogAboutVisible" title="About NetProbe">
        <AboutPage></AboutPage>
        <template #footer>
            <span class="dialog-footer">
