export const sleep = (msec: number | undefined) => new Promise(resolve => setTimeout(resolve, msec));
...
export function isValidIPv6Address(ipaddress: string)
{
...
export function isIpv4NetworkAddress(ipAddress: string){
...
export function isIpv6NetworkAddress(ipAddress: string){
