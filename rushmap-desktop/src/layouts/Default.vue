...
//import RushMapLogo from "../assets/rushmap_icon.png";
...
<template>
        ...
        <el-container>
            <el-header>
                <el-menu :default-active="activeIndex" mode="horizontal" :ellipsis="false" @select="handleSelect">
                    ...
                    <!-- <router-link to="/">
                        <img class="img" :src="RushMapLogo" width="40" style="margin-left: 4px; margin-top: 10px" />
                    </router-link> -->
    ...
    <el-dialog v-model="dialogAboutVisible" title="About RushMap Desktop">
        <AboutPage></AboutPage>
        <template #footer>
            <span class="dialog-footer">
